import { LeadStatus, EmailStatus, STATUS_COLORS, STATUS_ICONS } from "@/types";

/**
 * Get status color classes for UI components
 */
export function getStatusColor(type: 'lead' | 'email', status: LeadStatus | EmailStatus): string {
 ...
 */
export function getStatusIcon(type: 'lead', status: LeadStatus): string {
  return STATUS_ICONS[type][status] || "📋";
}
 ...
 */
export function getResponsiveClass(base: string, mobile?: string, desktop?: string): string {
  let classes = base;
